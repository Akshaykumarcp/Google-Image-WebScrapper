# -*- coding: utf-8 -*-
"""
Created on Tue Jan 28 04:57:29 2020

@author: Akshay kumar C P
"""
# data layer to interact with api's, web page etc
...
class ScrapperImage:
    ...
    def createImageURL(searchterm):
        searchterm=searchterm.split() # if two keywords 
        searchterm = "+".join(searchterm) # if space replace with +
    ...
    def getimageUrlList(rawHtml):
        imageUrlList = []
        for a in rawHtml.find_all("div",{"class":"rg_meta"}): # googles img inspect
